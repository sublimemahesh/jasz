            ...
            <div class="container-fluid">  
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h2>Arrange Offer Banners</h2>
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="create-offer-banner.php">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/offer-banner.php" class="form-horizontal" >
                                                        ...
                                                        foreach ($BANNER->all() as $key => $img) {
                                                            ...
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    ...
                                                                    <img class="img-responsive" src="../upload/offer-banner/<?php echo $img["image_name"]; ?>" alt=""/>
