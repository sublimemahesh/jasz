                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form class="form-horizontal"  method="post" action="post-and-get/sub-category.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">                                       
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <img src="../upload/category/sub/<?php echo $SUB_CATEGORY->imageName; ?>" id="image" class="view-edit-img-comments img img-responsive img-thumbnail" name="image" alt="old image">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">                                       
                                    ...
                                    <div class="col-md-12"> 
                                        <input type="hidden" id="oldImageName" value="<?php echo $SUB_CATEGORY->imageName; ?>" name="oldImageName"/>
