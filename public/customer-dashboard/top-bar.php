    ...
    <div class="navbar navbar-default">
        <div class="navbar-header">
            <a class="navbar-brand navbar-brand-center" href="index-2.html">
                <img class="navbar-brand-logo" src="../static/media/logo.1d83525e.png" alt="Elephant">
            </a>
            ...
            <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse" data-target="#navbar">
                ...
                <span class="ellipsis ellipsis-vertical">
                    <img class="ellipsis-object" width="32" height="32" src="../static/media/logo.1d83525e.png" alt="Galle It">
                </span>
            </button>
        </div>
