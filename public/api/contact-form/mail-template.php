                                                            ...
                                                            <tbody>
                                                                <tr><td>
                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody><tr>
                                                                                    <td width="182">
                                                                                        <a href="' . $site_link . '" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://www.gallecabsandtours.com&amp;source=gmail&amp;ust=1574393192616000&amp;usg=AFQjCNGNM8_Z7ZMe7ndwFlJuHEP29nDd3Q"> <img src="https://ci5.googleusercontent.com/proxy/Q8VVTcwQyqx4nPD9ByvARF-aFDJSrlPZTsXcobnLvgo4E16lC9A20uUoTRCnu_Xd7CIoBaRn9HJtztKfyHjhd9xa690HX6HbfA=s0-d-e1-ft#' . $site_link . '/distance/img/logo.png" alt="" class="CToWUd" border="0">
                                                                                        </a>
                                                                                    </td>
                                                                                    <td width="393">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0"> 
                                                            <tbody>
                                                                <tr><td>
                                                                    ...
                                                                    <td style="font-size:20px;color:#33468f;line-height:28px;font-family:Arial,Helvetica,sans-serif;padding-bottom:20px;padding-top: 0px;font-weight: 600;" align="left"> ' . $companySubject . ' </td> 
                                                                </tr>
                                                            </tbody> 
                                                        </table> 
                                                        <table style="background-color:#f5f7fa" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#F5F7FA"> 
                                                            ...
                                                            <tbody> 
                                                                <tr> 
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <font style="font-family:Verdana,Geneva,sans-serif;color:#68696a;font-size:14px">
                                                                                Email : <a href="mailto:'. $visitor_phone .'" rel="noreferrer" target="_blank">' . $visitor_email . '</a>
                                                                            </font>
                                                                        </li>
                                                                    </ul>
                                                                </tr> 
