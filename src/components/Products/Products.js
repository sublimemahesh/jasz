    ...
    render() {
        ...
        return (
                <div className="">
                    ...
                    <div id="content">
                        <div class="row">
                            <div class="product-search col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                                <div class="s002">
                                    <form action="/products">
                                        <div class="inner-form">
                                            ...
                                            <div class="input-field fifth-wrap">
                                                <button class="btn-search" type="button" onClick={this.getProductsByCategories}>SEARCH</button>
