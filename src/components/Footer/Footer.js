                                ...
                                <div className="col-md-3 col-sm-6 col-xs-12">
                                    <div className="item-box-footer2">
                                        ...
                                        <ul className="contact-footer2">
                                            <li><i className="fa fa-map-marker"></i> No. 164, Main Street, Galle</li>
                                            <li><i className="fa fa-mobile"></i> (+94) 71 850 8080</li>
                                            <li><i className="fa fa-phone"></i> (+94) 91 222 6622</li>
                                            <li><i className="fa fa-envelope-o"></i> mangala@galleit.com</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-5 col-sm-5 col-xs-12">
                                    <div className="copyright2">
                                        <p>Copyright DIGIZONE.LK © 2020. All Rights Reserved. </p>
