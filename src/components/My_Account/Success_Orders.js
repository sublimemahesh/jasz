...
class Success_Orders extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        this.getSuccessOrdersByMember = this.getSuccessOrdersByMember.bind(this);

    }
    componentWillMount() {

        this.checkAuthentication();
        this.getSuccessOrdersByMember();
    }
    checkAuthentication() {
