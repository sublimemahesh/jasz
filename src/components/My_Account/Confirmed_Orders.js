...
class Confirmed_Orders extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        this.getConfirmedOrdersByMember = this.getConfirmedOrdersByMember.bind(this);

    }
    componentWillMount() {

        this.checkAuthentication();
        this.getConfirmedOrdersByMember();
    }
    checkAuthentication() {
                    ...
                    <div className="row">
                        <div className="col-xs-12">
                            <div className="card order-card">
                                ...
                                <h2 className="order-card-title">My Confirmed Orders</h2>
                                <hr />
...
export default Confirmed_Orders;